...
int main(){
    ...
    DenPop1 = ( População1 ) / ( Area1 ); //adiciona a duvisão que vai usar os dados de população1 e area1, para densidade populacional e aplica a mesma ideia para o PIB per capita
